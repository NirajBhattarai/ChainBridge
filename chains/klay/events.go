...
// 	record, err := l.genericHandlerContract.GetDepositRecord(&bind.CallOpts{From: ("github.com/ethereum/go-ethereum/common".Address)(l.conn.Keypair().CommonAddress())}, uint64(nonce), uint8(destId))
// 	if err != nil {
